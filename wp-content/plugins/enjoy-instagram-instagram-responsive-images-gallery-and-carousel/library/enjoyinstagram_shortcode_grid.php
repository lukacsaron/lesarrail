...
foreach ($result as $entry) {
	...
	$shortcode_content .=  "<li class=\"col-md-2 insta-image\"><a title=\"{$caption}\" class=\"swipebox_grid\" href=\"{$entry['images']['thumbnail']['url']}\"><img  src=\"{$entry['images']['thumbnail']['url']}\"></a></li>";
