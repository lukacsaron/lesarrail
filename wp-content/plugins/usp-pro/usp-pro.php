	...
	class USP_Pro {
		...
		public static function advanced_defaults() {
			$defaults = array(
				...
				'custom_after'       => '</div>',
				'error_before'       => '<div class="usp-errors"><div class="usp-errors-heading"><strong>IMPORTANT!</strong> Please check the following fields:</div>',
				'error_after'        => '</div>',
		...
		public static function more_defaults() {
			$defaults = array(
				'tax_before'          => '<div class="usp-error">' . __('Mandatory field: ', 'usp'),
				'tax_after'           => '</div>',
				'custom_field_before' => '<div class="usp-error">' . __('Mandatory field: ', 'usp'),
				'custom_field_after'  => '</div>',
				'error_sep'           => '',
				
				'usp_error_1_desc'  => '<div class="usp-error">' . __('Mandatory field: Your Name', 'usp') . '</div>',
				'usp_error_2_desc'  => '<div class="usp-error">' . __('Mandatory field: Post URL', 'usp') . '</div>',
				'usp_error_3_desc'  => '<div class="usp-error">' . __('Mandatory field: Post Title', 'usp') . '</div>',
				'usp_error_4_desc'  => '<div class="usp-error">' . __('Mandatory field: Post Tags', 'usp') . '</div>',
				'usp_error_5_desc'  => '<div class="usp-error">' . __('Mandatory field: Challenge Question', 'usp') . '</div>',
				'usp_error_6_desc'  => '<div class="usp-error">' . __('Mandatory field: Post Category', 'usp') . '</div>',
				'usp_error_7_desc'  => '<div class="usp-error">' . __('Mandatory field: Post Content', 'usp') . '</div>',
				'usp_error_8_desc'  => '<div class="usp-error">' . __('Mandatory field: File(s)', 'usp') . '</div>',
				'usp_error_9_desc'  => '<div class="usp-error">' . __('Mandatory field: Email Address', 'usp') . '</div>',
				'usp_error_10_desc' => '<div class="usp-error">' . __('Mandatory field: Email Subject', 'usp') . '</div>',
				'usp_error_11_desc' => '<div class="usp-error">' . __('Mandatory field: Alt text', 'usp') . '</div>', 
				'usp_error_12_desc' => '<div class="usp-error">' . __('Mandatory field: Caption', 'usp') . '</div>', 
				'usp_error_13_desc' => '<div class="usp-error">' . __('Mandatory field: Description', 'usp') . '</div>', 
				'usp_error_14_desc' => '<div class="usp-error">' . __('Mandatory field: Taxonomy', 'usp') . '</div>',
				'usp_error_15_desc' => '<div class="usp-error">' . __('Mandatory field: Post Format', 'usp') . '</div>',
				
				'usp_error_a_desc' => '<div class="usp-error">' . __('Mandatory field: User Nicename', 'usp') . '</div>',
				'usp_error_b_desc' => '<div class="usp-error">' . __('Mandatory field: User Display Name', 'usp') . '</div>',
				'usp_error_c_desc' => '<div class="usp-error">' . __('Mandatory field: User Nickname', 'usp') . '</div>',
				'usp_error_d_desc' => '<div class="usp-error">' . __('Mandatory field: User First Name', 'usp') . '</div>',
				'usp_error_e_desc' => '<div class="usp-error">' . __('Mandatory field: User Last Name', 'usp') . '</div>',
				'usp_error_f_desc' => '<div class="usp-error">' . __('Mandatory field: User Description', 'usp') . '</div>',
				'usp_error_g_desc' => '<div class="usp-error">' . __('Mandatory field: User Password', 'usp') . '</div>',
