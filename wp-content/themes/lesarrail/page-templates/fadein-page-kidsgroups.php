<?php
/**
 * Template Name: Dual Content Page
 *
               ...
               <div id="primary" class="col-md-6 content-area">
                    ...
                    <main id="main" class="site-main" role="main">
                        ...
                        <?php while ( have_posts() ) : the_post(); ?>
                            ...
                            <?php   $second_title = get_post_meta($post->ID, "wpcf-second-title", false);
                                    $second_content = get_post_meta($post->ID, "wpcf-second-content", false);
                            ?>
