...
<body <?php body_class(); ?>>    
    ...
    <div class="navbar navbar-default navbar-fixed-top hide-md">
        <div class="navbar-header">
            <a class="navbar-brand" href="<?php echo esc_url( home_url( '/' ) ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home"><img src="http://beta.lesarrail.co.uk/wp-content/themes/lesarrail/img/logo_title.svg" height="20px"></a>
        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="navbar-header">
                                ...
                                <a class="navbar-brand" href="<?php echo esc_url( home_url( '/' ) ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home"><img src="http://beta.lesarrail.co.uk/wp-content/themes/lesarrail/img/logo_title.svg" width="182px"></a>
